...
RNF-033 & Debe incorporar integracion continua para ejecutar validaciones automaticas en cada cambio. \\
RNF-034 & Debe contemplar entrega continua controlada con compuertas de aprobacion. \\
\bottomrule
\end{longtable}
...
\begin{itemize}
  \item R version 4.x o superior.
  \item RStudio Desktop.
  \item Paquetes requeridos: shiny, bs4Dash, jsonlite, tidyverse, plotly, DT, shinyWidgets.
\end{itemize}
...
\midrule
Desarrollo minimo & 1 GB RAM y 1 vCPU. \\
Produccion (App + PostgreSQL) & 2 GB RAM y 1-2 vCPU, apto para decenas de miles de documentos. \\
...
\begin{itemize}
  \item Entorno de ejecucion: R 4.2.0 o superior.
  \item Sistema operativo local soportado: Windows 10/11, Ubuntu 20.04+ o Debian 11+.
...
\subsection{Requisitos para VPS (produccion recomendada)}
\begin{longtable}{p{0.35\textwidth} p{0.55\textwidth}}
\toprule
\textbf{Componente} & \textbf{Especificacion recomendada} \\
\midrule
Sistema operativo & Ubuntu Server 22.04 LTS o Debian 12 (64-bit). \\
CPU & 2 vCPU dedicadas (minimo 1 vCPU para cargas bajas). \\
Memoria RAM & 2 GB minimo; 4 GB recomendada para crecimiento y concurrencia. \\
Disco & 30 GB SSD minimo (incrementar segun volumetria documental). \\
Runtime & R 4.2+ y librerias del proyecto instaladas en entorno limpio. \\
Base de datos & PostgreSQL 13+ en el mismo VPS o instancia separada. \\
Red y seguridad & HTTPS con certificado TLS, acceso SSH restringido y respaldos programados. \\
\bottomrule
\end{longtable}
