      ...
      tagList(
        ...
        fluidRow(
          ...
          column(4,
            ...
            selectInput("submit_estado", NULL, choices = c("Activo", "Retirado", "Retirado", "Pensionado"), width = "100%")
          )
        ),
        fluidRow(
          column(6,
  ...
  output$admin_control_table <- renderUI({
    ...
    filas <- lapply(1:nrow(df_view), function(i) {
      ...
      if (session_state$modulo == "Archivo") {
        ...
        color_st <- switch(f$estado, "Activo" = "#28a745", "Retirado" = "#dc3545", "Retirado" = "#6f42c1", "Pensionado" = "#0056b3", "#6c757d")
        tags$tr(
